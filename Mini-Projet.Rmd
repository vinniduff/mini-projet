...
plot(xic)
par(mfrow=c(1,2))
plot(x=xic_df$Date, y=xic_df$Adjusted, type='l', xlab="Date", ylab=name, main=paste0(name, " as a function of Date"))
plot(x=xic_df$Date, y=xic_df$logreturn, type='l', xlab="Date", ylab=name, main=paste0(name, " as a function of Date"))
